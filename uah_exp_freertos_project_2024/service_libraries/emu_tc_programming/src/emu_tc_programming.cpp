...
//TODO (DONE)
// Los valores que queremos de Kpx y Kpy los cambiamos en el segundo 4 debido al LOG dado
EmuGSS_TCProgram129_2 prog_FT_00XX_step_0(UNITIME_AFTER_POWER_ON + 4,
					"FT_UAH_EXP_step 0, Set Kpx=0.2 and Kpy=0.2", 0.2, 0.2);

// Los valores que queremos de CVx y CVy los cambiamos en el segundo 8 debido al LOG dado
...
// Los valores que queremos de Kpx y Kpy los cambiamos en el segundo 34 debido al LOG dado
EmuGSS_TCProgram129_2 prog_FT_00XX_step_2(UNITIME_AFTER_POWER_ON + 34,
					"FT_UAH_EXP_step 2, Set Kpx=0.5 and Kpy=0.5", 0.5, 0.5);

// Los valores que queremos de CVx y CVy los cambiamos en el segundo 38 debido al LOG dado
...
// Para terminar el código, mando un TC[128,1] para los 100s de misión especificados
EmuGSS_TCProgram128_1 prog_FT_00XX_step_4(UNITIME_AFTER_POWER_ON + 100,"FT_UAH_EXP_step 3, Reset");
